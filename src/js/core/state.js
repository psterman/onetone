(function(global){
  ...
  const ui={drawerOpen:false,settingsPanel:'basic',sceneTab:'keys',habitLayer:'global',habitView:'hub',habitHubFilter:'all',habitHubSort:'recent',habitHubViewMode:'list',voiceEditSchemeId:null};

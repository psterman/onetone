(function(global){
  ...
  function renderSoundSettingsPanel(){
    ...
    [
      ...
      ['soundKeyCueGroupTitle',d.soundKeyCueGroupTitle||d.soundEmbedStripTitle||'提示音'],
      ['soundLegacyFoldTitle',d.soundLegacyFoldTitle||'传统提示（兼容）'],
      ['soundLegacyFoldHint',d.soundLegacyFoldHint||'语音唤醒、发送结果等旧槽；一般不必改，需要时再展开。'],
      ...
      ['cameraSoundEmbedTitle',d.soundEmbedStripTitle],
      ['cameraSoundActionLbl',d.soundSlotCameraActionTitle],
      ['btnCameraOpenSoundsMore',d.soundEmbedMoreSounds],

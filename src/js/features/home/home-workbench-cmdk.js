(function(global){
  ...
  function commands(){
    return [
      ...
      {id:'runtime', labelKey:'homeWbNavRuntime', hintKey:'homeWbCmdkHintSettings', panel:'debug'},
      {id:'log', labelKey:'homeWbQuickLog', hintKey:'homeWbCmdkHintSettings', panel:'debug', debugMode:'developer'}
    ];
  }

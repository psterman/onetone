...
return Promise.resolve()
  ...
  .then(function () {
    ...
    assert.ok(pickerSrc.indexOf('CURSOR_COMMON_SLOTS') >= 0);
    assert.ok(pickerSrc.indexOf('renderCursorPickHtml') >= 0);
    assert.ok(pickerSrc.indexOf('data-cursor-pick-select') >= 0);
    assert.ok(pickerSrc.indexOf('data-cursor-pick-bind') >= 0);
    assert.ok(pickerSrc.indexOf('pushToTalk') >= 0);
    assert.ok(pickerSrc.indexOf('CAMERA_COMMON_REFS') >= 0);
    assert.ok(pickerSrc.indexOf('renderCameraPickHtml') >= 0);
    assert.ok(pickerSrc.indexOf('data-camera-pick-select') >= 0);
    assert.ok(pickerSrc.indexOf('data-camera-pick-bind') >= 0);
    assert.ok(pickerSrc.indexOf('deliberateBlink') >= 0);
    assert.ok(pickerSrc.indexOf('previewPickSelection') >= 0);
    assert.ok(pickerSrc.indexOf('syncVoicePickIdFromSelection') >= 0);
    assert.ok(pickerSrc.indexOf('syncCursorPickIdFromSelection') >= 0);
    assert.ok(pickerSrc.indexOf('syncCameraPickIdFromSelection') >= 0);
    assert.ok(pickerSrc.indexOf("previewPickSelection('voice')") >= 0);
    assert.ok(pickerSrc.indexOf("previewPickSelection('cursor')") >= 0);
    assert.ok(pickerSrc.indexOf("previewPickSelection('camera')") >= 0);
    assert.ok(pickerSrc.indexOf('previewCustomKeyMatch') >= 0);
    assert.ok(pickerSrc.indexOf('customKeyMatchEditId') >= 0);
    assert.ok(pickerSrc.indexOf('Do not core.focus') >= 0 || pickerSrc.indexOf('Leaves selectedMappingId alone') >= 0);
    assert.ok(pickerSrc.indexOf('recordCustomKeyMatchLaunch') >= 0);
    assert.ok(pickerSrc.indexOf('keysCustomKeyMatchLaunch') >= 0);
    assert.ok(pickerSrc.indexOf('schedulePersistHeroSave') >= 0);
    assert.ok(pickerSrc.indexOf("source: 'captureHero'") >= 0 || pickerSrc.indexOf('source: "captureHero"') >= 0);
    assert.ok(pickerSrc.indexOf("kind: 'customKey'") >= 0 || pickerSrc.indexOf('kind: "customKey"') >= 0 || pickerSrc.indexOf("'customKey'") >= 0);
    assert.ok(pickerSrc.indexOf('resolveCustomKeyHeroCap') >= 0);
    assert.ok(pickerSrc.indexOf("activeTab === 'key'") >= 0);
    assert.ok(pickerSrc.indexOf('syncRecognitionEditorPreview') >= 0);
    assert.ok(pickerSrc.indexOf('renderStepHints') >= 0);
    assert.ok(pickerSrc.indexOf('showHeroOnTarget') >= 0 || pickerSrc.indexOf('mountTargetRecordToCapture') >= 0);
    assert.ok(pickerSrc.indexOf("activeTab === 'softPad'") >= 0);
    // Custom-key list recovers trigger-only matches (e.g. Ctrl+Shift+D).
    ...
    assert.ok(html.indexOf('屏幕按键') >= 0 || html.indexOf('keysChannelTabSoftPad') >= 0);

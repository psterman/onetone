...
assert.ok(css.includes('width:min(210px,100%)') || css.includes('width:230px'), 'single-frame veteran viewport');
assert.ok(css.includes('.cards-container.has-selection .mode-card'), 'selection focus CSS');

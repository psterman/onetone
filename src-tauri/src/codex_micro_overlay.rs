...
pub struct CodexMicroOverlaySnapshot {
    ...
    pub skin: String,
    /// Whole Soft Pad float opacity as percent (40–100).
    #[serde(default = "default_screen_opacity_snap", rename = "screenOpacity")]
...
fn build_snapshot_from_cfg(cfg: &VoiceConfig) -> CodexMicroOverlaySnapshot {
    ...
    CodexMicroOverlaySnapshot {
        ...
        screen_opacity: clamp_screen_opacity(pad.screen_opacity),

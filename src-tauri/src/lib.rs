...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::cmd_action_binding_views_all,
            ...
            ipc::cmd_codex_micro_overlay_fit_content,
            ...
            ipc::cmd_codex_micro_pad_set_ambient,
